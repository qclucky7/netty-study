 ...
 **/
public class SimpleNettyServerHandler extends SimpleChannelInboundHandler<DubboRequest> {

    @Override
    protected void channelRead0(ChannelHandlerContext channelHandlerContext, DubboRequest dubboRequest) throws Exception {

        System.out.println("[NettyServerHandler] channelRead msg = " + dubboRequest.toString());
        // 1. 根据类名返回对象
